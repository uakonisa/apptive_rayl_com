...
class AuthSignupHomeIn(Home):
    ...
    def web_auth_signup(self, *args, **kw):
        ...
        config = request.env['ir.config_parameter'].sudo().search(
            [('key', '=', 'website_terms_conditions.terms_and_conditions')])
        qcontext['web_term_condition'] = config.value
