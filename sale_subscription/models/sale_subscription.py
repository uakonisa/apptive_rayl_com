...
class SaleSubscription(models.Model):
    ...
    def action_synch_payments(self):
        return 1
    ...
    payment_gateway_sub_id = fields.Text(string="Payment Gateway Subscription ID")
    ...
    def _compute_next_invoice_date(self):
        for subscription in self:
            if subscription.partner_id.stripe_subscription_end_date:
                subscription.compute_next_invoice_date = fields.Date.from_string(subscription.partner_id.stripe_subscription_end_date)
            else:
                subscription.compute_next_invoice_date = subscription.recurring_next_date

    compute_next_invoice_date = fields.Date(compute="_compute_next_invoice_date")
