odoo.define('rayl_appointments.MyCustomAction',  function (require) {
"use strict";
...
var MyCustomAction = AbstractAction.extend({
    ...
    cssLibs: [
        '/rayl_appointments/static/src/scss/lib/nv.d3.css'
    ],
    jsLibs: [
        '/rayl_appointments/static/src/js/lib/d3.min.js',
        '/rayl_appointments/static/src/js/Chart.js',
